      ...
      <el-form ref="form"
        ...
        <el-form-item title="">
          <el-input type="text"
                    ...
                    style="width:820px"
                    placeholder="请输入待查询的以太坊地址" id="input1"></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <div v-show="blockHashQuery">
        <table class="AdressTable">
            ...
            <tr>
              <td>首次交易哈希</td>
              <td>
                <router-link :to="{ name: 'ethTransactionQuery', params: { msgKey: info.first_tx}}" style="color:#409eff">
            ...
            <tr>
              <td>最近交易哈希</td>
              <td>
                <router-link :to="{ name: 'ethTransactionQuery', params: { msgKey: info.last_tx}}" style="color:#409eff">
        ...
        <el-table :data="txlist.slice((currentPage-1)*pagesize,currentPage*pagesize)" 
...
export default {
  ...
  methods: {
    ...
    choose_date(){
      ...
      console.log('提交')
      console.log(this.form)
      this.$axios.get('http://10.176.34.161:8000/api/basicquery/address/eth/relatedtxs/'+this.form.address+'/').then(res => {         
          this.txlist=[]
    ...
    onSubmit () { 
      ...
      var url = 'http://10.176.34.161:8000/api/basicquery/address/eth/'+this.form.address +'/'
      var url2 ='http://10.176.34.161:8000/api/basicquery/address/eth/relatedtxs/'+this.form.address+'/'
      // console.log(url)
      console.log(url2)
