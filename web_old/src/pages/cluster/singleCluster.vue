  ...
  <div>
    ...
    <div class="homeBody_Single">
      <el-form :model="form"
        ...
        <p class="homeBody_Single_Title">单地址聚类</p>
          ...
          <el-col :span="19">
            <el-form-item label="找零规则的选择和权重">
              <el-select v-model="form.rule_map_key"
                ...
                <el-option label="lt"
                           value="lt"></el-option>
                <el-option label="lt_pc"
                           value="lt_pc"></el-option>
                <el-option label="lt_dp"
                           value="lt_dp"></el-option>
                <el-option label="lt_na"
                           value="lt_na"></el-option>
                <el-option label="lt_pc_dp"
                           value="lt_pc_dp"></el-option>
                <el-option label="lt_pc_na"
                           value="lt_pc_na"></el-option>
                <el-option label="lt_pc_dp_na"
...
export default {
  ...
  methods: {
    ...
    onSubmit () {
      ...
      this.$axios
        .post('http://10.176.34.161:8001/api/analysis/cluster/add', form).then(res => {
